...
OUT = r"C:\Users\ok\AppData\Local\Temp\opencode\live\portrait_cards_real.html"
...
async def run():
    async with async_playwright() as p:
        ...
        await page.evaluate("professionalPortraitCards()")
        await page.wait_for_timeout(5000)
        print("portrait print url:", page.url[:140])
        content = await page.content()
        with open(OUT, "w", encoding="utf-8") as f:
            f.write(content)
        print("Saved portrait_cards_real.html:", len(content), "bytes, url:", page.url[:120])
