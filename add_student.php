...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 767px) { .page-wrapper { padding: 12px 16px 28px; } .form-grid, .form-grid-2 { grid-template-columns: repeat(2, 1fr); } .main-layout { grid-template-columns: minmax(0, 1fr) minmax(140px, 200px); gap: 12px; } .top-bar { flex-direction: column; align-items: stretch; gap: 8px; } .top-bar-right { flex-wrap: wrap; } .top-bar-right .search-box { max-width: 100%; } .main-tabs .tab-btn span { display: none; } .main-tabs .tab-btn i { font-size: 16px; } .sub-tabs .subtab-btn span { display: none; } .sub-tabs .subtab-btn i { font-size: 14px; } .progress-steps .divider { display: none; } .progress-steps .step .info .sub { display: none; } .form-actions .note { margin-left: 0; width: 100%; } .form-actions { flex-wrap: wrap; } .photo-widget { position: static; } .table-wrapper table { min-width: 480px; } }
    @media (max-width: 479px) { .page-wrapper { padding: 10px 12px 24px; } .form-grid, .form-grid-2 { grid-template-columns: repeat(2, 1fr); gap: 10px; } .main-layout { grid-template-columns: minmax(0, 1fr) 130px; gap: 10px; } .doc-grid { grid-template-columns: 1fr 1fr; } .main-tabs .tab-btn { padding: 4px 10px; font-size: 10px; } .main-tabs .tab-btn span { display: none; } .main-tabs .tab-btn i { font-size: 14px; } .top-bar { flex-direction: column; align-items: stretch; gap: 6px; } .top-bar-right .search-box { max-width: 100%; } .sub-tabs .subtab-btn { padding: 4px 8px; font-size: 10px; } .sub-tabs .subtab-btn span { display: none; } .sub-tabs .subtab-btn i { font-size: 14px; } .progress-steps { flex-direction: row; align-items: center; gap: 8px; } .progress-steps .divider { display: none; } .progress-steps .step .info .sub { display: none; } .form-actions { flex-direction: row; flex-wrap: wrap; align-items: center; } .form-actions .note { margin-left: 0; } .btn-primary, .btn-secondary, .btn-success { justify-content: center; } .photo-widget { max-width: none; margin: 0; } .table-wrapper table { min-width: 380px; } }
